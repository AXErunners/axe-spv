...
const SpvChain = class {
  ...
  /** @private
   * validates a axecore.BlockHeader object
   *
   * @param {Object} header
   ...
   * between two adjacent axecore.BlockHeader objects
   *
   * @param {Object} header
  ...
  /**
   * gets the axecore.BlockHeader object the longest chain tip
   *
  ...
  /**
   * gets the axecore.BlockHeader object for a specific block hash
   *
   * @param {string} hash
   * @return {Object} header
   */
